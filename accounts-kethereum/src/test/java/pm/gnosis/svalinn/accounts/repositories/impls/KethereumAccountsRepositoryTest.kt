...
class KethereumAccountsRepositoryTest {
    ...
    fun signTransactionLegacyEIP155Example() {
        ...
        val transaction = Transaction.Legacy(to = address, nonce = nonce, value = value, gas = gas, gasPrice = gasPrice, chainId = BigInteger.ONE)
    ...
    fun rlpTransactionLegacyExtension() {
        ...
        val gasPrice = BigInteger("20000000000")
        val transaction =
            Transaction.Legacy(to = address, nonce = nonce, data = "0xe411526d", gas = gas, gasPrice = gasPrice, chainId = BigInteger.valueOf(28))
    ...
    fun signTransactionCreateSafe() {
        ...
        val gas = BigInteger("2034776")
        val gasPrice = BigInteger("20000000000")
        val transaction = Transaction.Legacy(to = address, nonce = nonce, data = CREATE_SAFE_DATA, gas = gas, gasPrice = gasPrice, chainId = BigInteger.ZERO)
